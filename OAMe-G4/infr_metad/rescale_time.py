...
barrier = 0 #from plumed.dat input file for OPES

T = 300 #Temperature in K

biasColumn = 4 #Column in which the bias is printed in the COLVAR file
...
for i in range(len(cv)):
    ...
    print(cv[i,0],cv[i,1],c/time_unit,file=f1)
